 ...
 */
#[Schema(
    schema: 'BundleWebCareUpdateSiteParameters',
    title: 'Bundle WebCare Update Site Parameters',
    description: 'Parameters for updating a WebCare site configuration',
    type: 'object',
)]
final readonly class UpdateWebCareSiteParameters
{
