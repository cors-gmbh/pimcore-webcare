...
final class DeleteController extends AbstractApiController
{
    ...
    #[SuccessResponse(description: 'bundle_web_care_site_delete_by_id_success_response')]
    #[DefaultResponses([
        HttpResponseCodes::UNAUTHORIZED,
        HttpResponseCodes::NOT_FOUND,
    ])]
    public function deleteWebCareSite(int $id): Response
    {
        $this->webCareSiteService->deleteWebCareSite($id);
